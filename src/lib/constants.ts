...
export const TRUST_SIGNALS = [
  ...
  { id:'devnet',   label:'Devnet Deployment',             status:'planned'  as const, description:'Staking and challenge contracts deploying to Solana devnet with live explorer links.', link:'https://discord.gg/fitsol', linkLabel:'Follow on Discord', eta:'May 2026' },
]
...
export const JOB_POSTS = [
  ...
  { id:'community',    title:'Community Manager',            type:'Full-time' as const, rate:'$30-50/hr + Token Equity',  description:'Manage Discord, Telegram, and Twitter communities globally.', requirements:['Discord/Telegram moderation','Crypto community management','English fluency','Conflict resolution'], responsibilities:['Moderate channels','Answer support','Organize AMAs'] },
